...
public class DocumentUploadActivity extends AppCompatActivity implements
    ...
    private void setDateTimeField() {
        ...
        DatePickerDialog = new DatePickerDialog(DocumentUploadActivity.this, R.style.Dialog_Theme, new android.app.DatePickerDialog.OnDateSetListener() {

...
public class businessappNewStaffActivity extends AppCompatActivity {
    ...
    businessAppStaffInfoFragment userInfoFragment;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.businessapp_newstaff_activity);
        ...
        nextButton.setOnClickListener(v -> {
            ...
            if (position < maxPosition) {
                ...
                if(position == 1) {
                    ...
                    userInfoFragment =      new businessAppStaffInfoFragment();
    ...
    public void RegisterDriver(JsonObject jsonObject){
        ...
        //StartDialogue();
        com.webingate.paysmartbusinessapp.driverapplication.Utils.DataPrepare.get(businessappNewStaffActivity.this).getrestadapter()

...
public class businessappNewFleetOwnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.businessapp_newfleetowner_activity);
    ...
    public void RegisterDriver(JsonObject jsonObject){
        ...
        //StartDialogue();
        com.webingate.paysmartbusinessapp.driverapplication.Utils.DataPrepare.get(businessappNewFleetOwnerActivity.this).getrestadapter()
...
//                        editor.putString(VEHICLEID, response.getVehicleId());
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("New Fleet Owner");

...
public class businessappFleetOwnerDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.businessapp_fleetownerdetails_activity);
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Fleet Owner Details");

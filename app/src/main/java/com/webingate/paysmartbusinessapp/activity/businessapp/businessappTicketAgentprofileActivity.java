...
public class businessappTicketAgentprofileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
       ...
       firstname = prefs.getString(Username, null);
        ...
        fab.setOnClickListener(
                ...
                v ->
                {
                    ...
                    Intent intent = new Intent(this, businessappTicketAgentprofileActivity.class);

...
public class businessappEditTicketAgentActivity extends AppCompatActivity {
    ...
    businessAppEditTicketAgentInfoFragment userInfoFragment;
    ...
    private void initUI() {
        ...
        setupFragment(new businessAppEditTicketAgentInfoFragment());
        ...
        nextButton.setOnClickListener(v -> {
            ...
            if (position < maxPosition) {
                ...
                if(position == 1) {
                    ...
                    userInfoFragment =      new businessAppEditTicketAgentInfoFragment();
    ...
    public void RegisterDriver(JsonObject jsonObject){
        ...
        //StartDialogue();
        com.webingate.paysmartbusinessapp.driverapplication.Utils.DataPrepare.get(businessappEditTicketAgentActivity.this).getrestadapter()
...
//                        editor.putString(VEHICLEID, response.getVehicleId());
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Edit Ticket Agent Details");

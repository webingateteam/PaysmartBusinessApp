...
import com.webingate.paysmartbusinessapp.fragment.businessAppFragments.businessAppTicketAgentInfoFragment;
...
public class businessappNewTicketAgentActivity extends AppCompatActivity {
    ...
    businessAppTicketAgentInfoFragment userInfoFragment;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.businessapp_newticketagent_activity);
    ...
    private void initUI() {
        ...
        setupFragment(new businessAppTicketAgentInfoFragment());
        ...
        nextButton.setOnClickListener(v -> {
            ...
            if (position < maxPosition) {
                ...
                if(position == 1) {
                    ...
                    userInfoFragment =  new businessAppTicketAgentInfoFragment();
                ...
                if(position == 2)
                {
                    ...
                    object.addProperty("UserAccountNo","14991"+mno.getText().toString());
    ...
    public void RegisterDriver(JsonObject jsonObject){
        ...
        //StartDialogue();
        com.webingate.paysmartbusinessapp.driverapplication.Utils.DataPrepare.get(businessappNewTicketAgentActivity.this).getrestadapter()
...
//                        editor.putString(VEHICLEID, response.getVehicleId());
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("New Ticket Agent");

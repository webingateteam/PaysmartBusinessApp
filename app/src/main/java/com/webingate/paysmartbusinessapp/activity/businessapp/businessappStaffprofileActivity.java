...
public class businessappStaffprofileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
       ...
       firstname = prefs.getString(Username, null);
        ...
        fab.setOnClickListener(
                ...
                v ->
                {
                    ...
                    Intent intent = new Intent(this, businessappStaffprofileActivity.class);

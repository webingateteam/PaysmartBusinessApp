 ...
 */
public class businessappStaffListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public businessappStaffListAdapter(ArrayList<DrivermasterResponse> placeArrayList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.businessapp_stafflist_item, parent, false);

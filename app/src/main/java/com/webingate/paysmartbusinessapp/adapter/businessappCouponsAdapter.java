 ...
 */
public class businessappCouponsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public businessappCouponsAdapter(ArrayList<RegisterBusinessUsers> placeArrayList, Context mcontext) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.businessapp_couponslist_item, parent, false);

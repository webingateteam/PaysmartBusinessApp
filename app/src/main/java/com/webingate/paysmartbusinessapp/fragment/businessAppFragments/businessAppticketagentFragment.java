...
public class businessAppticketagentFragment extends Fragment {
   ...
   // AppDirectoryHome9CategoryAdapter categoryAdapter;
    ...
    private void initData() {
        productsList = DirectoryHome9Repository.getticketagentList();
...
//                                .commitAllowingStateLoss();
                    ...
                    case 2:
                        ...
                        intent = new Intent(getActivity(), businessappFleetOwnerListActivity.class);
                        startActivity(intent);
                        break;
                    case 3:
                        intent = new Intent(getActivity(), businessappBusinessOwnerListActivity.class);
                        startActivity(intent);
                        break;
                    case 4:
                        break;
